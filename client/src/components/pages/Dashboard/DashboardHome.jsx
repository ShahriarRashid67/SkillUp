...
import showAnimation from '../../../assets/Animation/134261-dashboard-developer.json';
const DashboardHome = () => {
  return (
    <div>
      <div className='md:flex items-center min-h-screen max-w-6xl mx-auto'>
        ...
        <div className='md:w-1/2 flex justify-center'>
          <div className='text pr-10'>
            ...
            <p>
              ...
              aid on any subject that you are studying.
            </p>
