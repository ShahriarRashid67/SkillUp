const StudentSteps = () => {
  return (
    <div>
      <div className='md:max-w-4xl max-w-5xl mx-auto pt-10 pb-12'>
        ...
        <div className='w-full flex relative'>
          ...
          <div className='w-7/12 rounded-[80px] hidden md:block absolute right-60 -bottom-36 border-t-4 border-r-4 h-60  border-gray-400'></div>
        </div>
        <div className='w-full flex md:justify-end my-16 relative'>
          ...
          <div className='w-7/12 rounded-[80px] hidden md:block absolute right-60 -bottom-36 border-t-4 border-l-4 h-60 border-gray-400'></div>
        </div>
